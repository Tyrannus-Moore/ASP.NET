...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                 <asp:TextBox CssClass="input_one" ID="tbAdmName" runat="server" OnTextChanged="useJSAjax" AutoPostBack="true"></asp:TextBox><asp:Label ID="lbWarning" runat="server" Text=""></asp:Label>
            </ContentTemplate>
</asp:UpdatePanel></p>
        ...
        <p class="p_input no_first"><span class="label_text">验&nbsp; 证 码:</span><asp:TextBox CssClass="input_one" ID="tbVC" runat="server"></asp:TextBox>
        <asp:Image ID="Image1" imageUrl="VerificationCode.aspx" runat="server" /><asp:Label ID="lbWarning2" runat="server" Text=""></asp:Label></p>
