...
<body>
    <form id="form1" runat="server">
        <div>
            <p class="p_input">
                用 户 名:<asp:TextBox ID="tbAdmName" CssClass="input_one" runat="server" Height="28px" Width="249px"></asp:TextBox>
                <asp:Label ID="lbWarningName" runat="server" ForeColor="Red" Height="23px"></asp:Label>
            </p>
            <p class="p_input">
                &nbsp; 密&nbsp; 码:<asp:TextBox ID="tbAdmPwd" CssClass="input_one" runat="server" TextMode="Password" Height="28px" Width="254px"></asp:TextBox>
                <asp:Label ID="lbWarningPwd" runat="server" ForeColor="Red" Height="23px"></asp:Label>
            </p>
            ...
            <asp:Button ID="tbRegister" runat="server" Text="注册" />
