...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.CMS_FriendLink dal=new Maticsoft.DAL.CMS_FriendLink();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.CMS_FriendLink GetModelByCache(int Id)
		{
			
			string CacheKey = "CMS_FriendLinkModel-" + Id;
			...
			return (Maticsoft.Model.CMS_FriendLink)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.CMS_FriendLink> GetModelList(string strWhere)
		{
